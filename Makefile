...
.PHONY: help build up up-full down restart logs shell test test-smoke bench bench-update clean-sessions
...
clean-sessions: ## Delete every session under ./sessions (logs, meta, ticket JSONs)
